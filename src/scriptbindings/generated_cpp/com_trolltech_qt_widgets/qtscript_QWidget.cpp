...
static QScriptValue qtscript_QWidget_prototype_call(QScriptContext *context, QScriptEngine *)
{
    ...
    case 5:
    if (context->argumentCount() == 0) {
        bool _q_result = _q_self->autoFillBackground();
    ...
    if (context->argumentCount() == 1) {
        ...
        _q_self->setAutoFillBackground(_q_arg0);
        return context->engine()->undefinedValue();
    }
    break;
    ...
    if (context->argumentCount() == 1) {
        ...
        _q_self->setWindowFilePath(_q_arg0);
        return context->engine()->undefinedValue();
    }
    break;
    ...
    case 96:
    if (context->argumentCount() == 0) {
        QString _q_result = _q_self->styleSheet();
        return QScriptValue(context->engine(), _q_result);
    }
    break;
    ...
    case 108:
    if (context->argumentCount() == 0) {
        QString _q_result = _q_self->windowFilePath();
        return QScriptValue(context->engine(), _q_result);
    }
    break;
