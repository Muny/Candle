...
{
    if ((value >= QMdiArea::CreationOrder) && (value <= QMdiArea::ActivationHistoryOrder))
        return qtscript_QMdiArea_WindowOrder_keys[static_cast<int>(value)-static_cast<int>(QMdiArea::CreationOrder)];
    return QString();
}
...
{
    int arg = context->argument(0).toInt32();
    if ((arg >= QMdiArea::CreationOrder) && (arg <= QMdiArea::ActivationHistoryOrder))
