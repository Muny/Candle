...
{
    if ((value >= QLocale::AnyLanguage) && (value <= QLocale::Maithili))
        return qtscript_QLocale_Language_keys[static_cast<int>(value)-static_cast<int>(QLocale::AnyLanguage)];
    return QString();
}
...
static QScriptValue qtscript_construct_QLocale_Language(QScriptContext *context, QScriptEngine *engine)
{
    ...
    if ((arg >= QLocale::AnyLanguage) && (arg <= QLocale::Maithili))
...
{
    if ((value >= QLocale::AnyCountry) && (value <= QLocale::Kosovo))
        return qtscript_QLocale_Country_keys[static_cast<int>(value)-static_cast<int>(QLocale::AnyCountry)];
    return QString();
}
...
{
    int arg = context->argument(0).toInt32();
    if ((arg >= QLocale::AnyCountry) && (arg <= QLocale::Kosovo))
...
{
    if ((value >= QLocale::AnyScript) && (value <= QLocale::VarangKshitiScript))
...
{
    int arg = context->argument(0).toInt32();
    if ((arg >= QLocale::AnyScript) && (arg <= QLocale::VarangKshitiScript))
