...
static QScriptValue qtscript_Qt_static_call(QScriptContext *context, QScriptEngine *)
{
    ...
    if (context->argumentCount() == 1) {
        if ((qMetaTypeId<QFlags<Qt::AlignmentFlag> >() == context->argument(0).toVariant().userType())) {
            QFlags<Qt::AlignmentFlag> _q_arg0 = qscriptvalue_cast<QFlags<Qt::AlignmentFlag> >(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<QFlags<Qt::DockWidgetArea> >() == context->argument(0).toVariant().userType())) {
            QFlags<Qt::DockWidgetArea> _q_arg0 = qscriptvalue_cast<QFlags<Qt::DockWidgetArea> >(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<QFlags<Qt::DropAction> >() == context->argument(0).toVariant().userType())) {
            QFlags<Qt::DropAction> _q_arg0 = qscriptvalue_cast<QFlags<Qt::DropAction> >(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<QFlags<Qt::ImageConversionFlag> >() == context->argument(0).toVariant().userType())) {
            QFlags<Qt::ImageConversionFlag> _q_arg0 = qscriptvalue_cast<QFlags<Qt::ImageConversionFlag> >(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<QFlags<Qt::InputMethodHint> >() == context->argument(0).toVariant().userType())) {
            QFlags<Qt::InputMethodHint> _q_arg0 = qscriptvalue_cast<QFlags<Qt::InputMethodHint> >(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<QFlags<Qt::ItemFlag> >() == context->argument(0).toVariant().userType())) {
            QFlags<Qt::ItemFlag> _q_arg0 = qscriptvalue_cast<QFlags<Qt::ItemFlag> >(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<QFlags<Qt::KeyboardModifier> >() == context->argument(0).toVariant().userType())) {
            QFlags<Qt::KeyboardModifier> _q_arg0 = qscriptvalue_cast<QFlags<Qt::KeyboardModifier> >(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<QFlags<Qt::MatchFlag> >() == context->argument(0).toVariant().userType())) {
            QFlags<Qt::MatchFlag> _q_arg0 = qscriptvalue_cast<QFlags<Qt::MatchFlag> >(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<QFlags<Qt::MouseButton> >() == context->argument(0).toVariant().userType())) {
            QFlags<Qt::MouseButton> _q_arg0 = qscriptvalue_cast<QFlags<Qt::MouseButton> >(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<QFlags<Qt::Orientation> >() == context->argument(0).toVariant().userType())) {
            QFlags<Qt::Orientation> _q_arg0 = qscriptvalue_cast<QFlags<Qt::Orientation> >(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<QFlags<Qt::TextInteractionFlag> >() == context->argument(0).toVariant().userType())) {
            QFlags<Qt::TextInteractionFlag> _q_arg0 = qscriptvalue_cast<QFlags<Qt::TextInteractionFlag> >(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<QFlags<Qt::ToolBarArea> >() == context->argument(0).toVariant().userType())) {
            QFlags<Qt::ToolBarArea> _q_arg0 = qscriptvalue_cast<QFlags<Qt::ToolBarArea> >(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<QFlags<Qt::TouchPointState> >() == context->argument(0).toVariant().userType())) {
            QFlags<Qt::TouchPointState> _q_arg0 = qscriptvalue_cast<QFlags<Qt::TouchPointState> >(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<QFlags<Qt::WindowState> >() == context->argument(0).toVariant().userType())) {
            QFlags<Qt::WindowState> _q_arg0 = qscriptvalue_cast<QFlags<Qt::WindowState> >(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<QFlags<Qt::WindowType> >() == context->argument(0).toVariant().userType())) {
            QFlags<Qt::WindowType> _q_arg0 = qscriptvalue_cast<QFlags<Qt::WindowType> >(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<Qt::ApplicationAttribute>() == context->argument(0).toVariant().userType())) {
            Qt::ApplicationAttribute _q_arg0 = qscriptvalue_cast<Qt::ApplicationAttribute>(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<Qt::ArrowType>() == context->argument(0).toVariant().userType())) {
            Qt::ArrowType _q_arg0 = qscriptvalue_cast<Qt::ArrowType>(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<Qt::AspectRatioMode>() == context->argument(0).toVariant().userType())) {
            Qt::AspectRatioMode _q_arg0 = qscriptvalue_cast<Qt::AspectRatioMode>(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<Qt::Axis>() == context->argument(0).toVariant().userType())) {
            Qt::Axis _q_arg0 = qscriptvalue_cast<Qt::Axis>(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<Qt::BGMode>() == context->argument(0).toVariant().userType())) {
            Qt::BGMode _q_arg0 = qscriptvalue_cast<Qt::BGMode>(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<Qt::BrushStyle>() == context->argument(0).toVariant().userType())) {
            Qt::BrushStyle _q_arg0 = qscriptvalue_cast<Qt::BrushStyle>(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<Qt::CaseSensitivity>() == context->argument(0).toVariant().userType())) {
            Qt::CaseSensitivity _q_arg0 = qscriptvalue_cast<Qt::CaseSensitivity>(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<Qt::CheckState>() == context->argument(0).toVariant().userType())) {
            Qt::CheckState _q_arg0 = qscriptvalue_cast<Qt::CheckState>(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<Qt::ClipOperation>() == context->argument(0).toVariant().userType())) {
            Qt::ClipOperation _q_arg0 = qscriptvalue_cast<Qt::ClipOperation>(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<Qt::ConnectionType>() == context->argument(0).toVariant().userType())) {
            Qt::ConnectionType _q_arg0 = qscriptvalue_cast<Qt::ConnectionType>(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<Qt::ContextMenuPolicy>() == context->argument(0).toVariant().userType())) {
            Qt::ContextMenuPolicy _q_arg0 = qscriptvalue_cast<Qt::ContextMenuPolicy>(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<Qt::Corner>() == context->argument(0).toVariant().userType())) {
            Qt::Corner _q_arg0 = qscriptvalue_cast<Qt::Corner>(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<Qt::CursorMoveStyle>() == context->argument(0).toVariant().userType())) {
            Qt::CursorMoveStyle _q_arg0 = qscriptvalue_cast<Qt::CursorMoveStyle>(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<Qt::CursorShape>() == context->argument(0).toVariant().userType())) {
            Qt::CursorShape _q_arg0 = qscriptvalue_cast<Qt::CursorShape>(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<Qt::DateFormat>() == context->argument(0).toVariant().userType())) {
            Qt::DateFormat _q_arg0 = qscriptvalue_cast<Qt::DateFormat>(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<Qt::DayOfWeek>() == context->argument(0).toVariant().userType())) {
            Qt::DayOfWeek _q_arg0 = qscriptvalue_cast<Qt::DayOfWeek>(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<Qt::DockWidgetArea>() == context->argument(0).toVariant().userType())) {
            Qt::DockWidgetArea _q_arg0 = qscriptvalue_cast<Qt::DockWidgetArea>(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<Qt::DropAction>() == context->argument(0).toVariant().userType())) {
            Qt::DropAction _q_arg0 = qscriptvalue_cast<Qt::DropAction>(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<Qt::FillRule>() == context->argument(0).toVariant().userType())) {
            Qt::FillRule _q_arg0 = qscriptvalue_cast<Qt::FillRule>(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<Qt::FocusPolicy>() == context->argument(0).toVariant().userType())) {
            Qt::FocusPolicy _q_arg0 = qscriptvalue_cast<Qt::FocusPolicy>(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<Qt::FocusReason>() == context->argument(0).toVariant().userType())) {
            Qt::FocusReason _q_arg0 = qscriptvalue_cast<Qt::FocusReason>(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<Qt::GestureState>() == context->argument(0).toVariant().userType())) {
            Qt::GestureState _q_arg0 = qscriptvalue_cast<Qt::GestureState>(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<Qt::GestureType>() == context->argument(0).toVariant().userType())) {
            Qt::GestureType _q_arg0 = qscriptvalue_cast<Qt::GestureType>(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<Qt::GlobalColor>() == context->argument(0).toVariant().userType())) {
            Qt::GlobalColor _q_arg0 = qscriptvalue_cast<Qt::GlobalColor>(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<Qt::InputMethodHint>() == context->argument(0).toVariant().userType())) {
            Qt::InputMethodHint _q_arg0 = qscriptvalue_cast<Qt::InputMethodHint>(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<Qt::InputMethodQuery>() == context->argument(0).toVariant().userType())) {
            Qt::InputMethodQuery _q_arg0 = qscriptvalue_cast<Qt::InputMethodQuery>(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<Qt::ItemDataRole>() == context->argument(0).toVariant().userType())) {
            Qt::ItemDataRole _q_arg0 = qscriptvalue_cast<Qt::ItemDataRole>(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<Qt::ItemSelectionMode>() == context->argument(0).toVariant().userType())) {
            Qt::ItemSelectionMode _q_arg0 = qscriptvalue_cast<Qt::ItemSelectionMode>(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<Qt::Key>() == context->argument(0).toVariant().userType())) {
            Qt::Key _q_arg0 = qscriptvalue_cast<Qt::Key>(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<Qt::LayoutDirection>() == context->argument(0).toVariant().userType())) {
            Qt::LayoutDirection _q_arg0 = qscriptvalue_cast<Qt::LayoutDirection>(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<Qt::MaskMode>() == context->argument(0).toVariant().userType())) {
            Qt::MaskMode _q_arg0 = qscriptvalue_cast<Qt::MaskMode>(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
            ...
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<Qt::PenCapStyle>() == context->argument(0).toVariant().userType())) {
            Qt::PenCapStyle _q_arg0 = qscriptvalue_cast<Qt::PenCapStyle>(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<Qt::PenJoinStyle>() == context->argument(0).toVariant().userType())) {
            Qt::PenJoinStyle _q_arg0 = qscriptvalue_cast<Qt::PenJoinStyle>(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<Qt::PenStyle>() == context->argument(0).toVariant().userType())) {
            Qt::PenStyle _q_arg0 = qscriptvalue_cast<Qt::PenStyle>(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<Qt::ScreenOrientation>() == context->argument(0).toVariant().userType())) {
            Qt::ScreenOrientation _q_arg0 = qscriptvalue_cast<Qt::ScreenOrientation>(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<Qt::ScrollBarPolicy>() == context->argument(0).toVariant().userType())) {
            Qt::ScrollBarPolicy _q_arg0 = qscriptvalue_cast<Qt::ScrollBarPolicy>(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<Qt::ShortcutContext>() == context->argument(0).toVariant().userType())) {
            Qt::ShortcutContext _q_arg0 = qscriptvalue_cast<Qt::ShortcutContext>(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<Qt::SizeHint>() == context->argument(0).toVariant().userType())) {
            Qt::SizeHint _q_arg0 = qscriptvalue_cast<Qt::SizeHint>(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<Qt::SizeMode>() == context->argument(0).toVariant().userType())) {
            Qt::SizeMode _q_arg0 = qscriptvalue_cast<Qt::SizeMode>(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<Qt::SortOrder>() == context->argument(0).toVariant().userType())) {
            Qt::SortOrder _q_arg0 = qscriptvalue_cast<Qt::SortOrder>(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<Qt::TextElideMode>() == context->argument(0).toVariant().userType())) {
            Qt::TextElideMode _q_arg0 = qscriptvalue_cast<Qt::TextElideMode>(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<Qt::TextFormat>() == context->argument(0).toVariant().userType())) {
            Qt::TextFormat _q_arg0 = qscriptvalue_cast<Qt::TextFormat>(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<Qt::TextInteractionFlag>() == context->argument(0).toVariant().userType())) {
            Qt::TextInteractionFlag _q_arg0 = qscriptvalue_cast<Qt::TextInteractionFlag>(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<Qt::TimeSpec>() == context->argument(0).toVariant().userType())) {
            Qt::TimeSpec _q_arg0 = qscriptvalue_cast<Qt::TimeSpec>(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<Qt::TimerType>() == context->argument(0).toVariant().userType())) {
            Qt::TimerType _q_arg0 = qscriptvalue_cast<Qt::TimerType>(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<Qt::ToolBarArea>() == context->argument(0).toVariant().userType())) {
            Qt::ToolBarArea _q_arg0 = qscriptvalue_cast<Qt::ToolBarArea>(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<Qt::ToolButtonStyle>() == context->argument(0).toVariant().userType())) {
            Qt::ToolButtonStyle _q_arg0 = qscriptvalue_cast<Qt::ToolButtonStyle>(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<Qt::TransformationMode>() == context->argument(0).toVariant().userType())) {
            Qt::TransformationMode _q_arg0 = qscriptvalue_cast<Qt::TransformationMode>(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<Qt::WidgetAttribute>() == context->argument(0).toVariant().userType())) {
            Qt::WidgetAttribute _q_arg0 = qscriptvalue_cast<Qt::WidgetAttribute>(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<Qt::WindowModality>() == context->argument(0).toVariant().userType())) {
            Qt::WindowModality _q_arg0 = qscriptvalue_cast<Qt::WindowModality>(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<Qt::WindowState>() == context->argument(0).toVariant().userType())) {
            Qt::WindowState _q_arg0 = qscriptvalue_cast<Qt::WindowState>(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        } else if ((qMetaTypeId<Qt::WindowType>() == context->argument(0).toVariant().userType())) {
            Qt::WindowType _q_arg0 = qscriptvalue_cast<Qt::WindowType>(context->argument(0));
            const char* _q_result = const_cast<const char*>(Qt::qt_getEnumName(_q_arg0));
            return qScriptValueFromValue(context->engine(), _q_result);
        }
    }
...
QScriptValue qtscript_create_Qt_class(QScriptEngine *engine)
{
    ...
    for (int i = 0; i < 1; ++i) {
        QScriptValue fun = engine->newFunction(qtscript_Qt_static_call,
            qtscript_Qt_function_lengths[i+1]);
        fun.setData(QScriptValue(engine, uint(0xBABE0000 + i+1)));
        ctor.setProperty(QString::fromLatin1(qtscript_Qt_function_names[i+1]),
