...
#define horizontalAdvance width
    ...
    painter.drawText(QPoint(this->width() - fm.horizontalAdvance(str) - 10, y + lh * 3), str);
    ...
    str = m_bufferState;
    painter.drawText(QPoint(this->width() - fm.horizontalAdvance(str) - 10, y + lh), str);
